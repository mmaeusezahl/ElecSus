...
def calc_energies(Bfield):
	A_ES = ES.Hamiltonian('IdealAtom','D1',1.0,Bfield)

	return A_ES.groundEnergies, A_ES.excitedEnergies
...
def calc_chi(X, p_dict,verbose=False):			   
	...
	lenergy, lstrength, ltransno = FreqStren(A_ES.groundManifold,
											 A_ES.excitedManifold,
											 A_ES.ds,A_ES.dp,Dline,
											 'Left',BoltzmannFactor,T+273.16)
	renergy, rstrength, rtransno = FreqStren(A_ES.groundManifold,
											 A_ES.excitedManifold,
											 A_ES.ds,A_ES.dp,Dline,
											 'Right',BoltzmannFactor,T+273.16)		
	zenergy, zstrength, ztransno = FreqStren(A_ES.groundManifold,
											 A_ES.excitedManifold,
											 A_ES.ds,A_ES.dp,Dline,
											 'Z',BoltzmannFactor,T+273.16)

	if Dline=='D1':
		transitionConst = AC.IdealD1Transition
